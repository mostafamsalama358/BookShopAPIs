    ...
    public partial class AddNewTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbBorrowings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TbBorrowings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TbBorrowings_TbBooks_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbUserBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TbUserBooks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TbUserBooks_TbBooks_BookId",
                        column: x => x.BookId,
                        principalTable: "TbBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TbBorrowings_BookId",
                table: "TbBorrowings",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_TbBorrowings_UserId",
                table: "TbBorrowings",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TbUserBooks_BookId",
                table: "TbUserBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_TbUserBooks_UserId",
                table: "TbUserBooks",
                column: "UserId");
        }
